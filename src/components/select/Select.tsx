			...
			<div className="raz-select__search">
				<Input
					...
					onChange={(e: ChangeEvent<HTMLInputElement>) =>
						handleInputChange(e.target.value)(options)(state, setState)(onChange)
					}
					...
					onBlur={() => change(null)(state)(setState)(onChange)}></Input>
			</div>
			<div className="raz-select__dropdown" style={{ width, minHeight: height }}>
				{state.filteredOptions.map((o, i) => (
					<Button
						role="option"
						key={i}
						onClick={(e) => handleSelect(e)(o)(options)(state, setState)(onChange)}
						layout="clear"
						width={width}
						height={height}
